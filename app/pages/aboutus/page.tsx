    ...
    return ( 
        <div className="mt-[150px] bg-white flex flex-col items-center font-serif">
            ...
            <div className="text-[15px] font-semibold text-gray-600 text-center w-[900px] mt-[10px] pb-[30px]">
                ...
                <br /><br />
                <strong className="text-[20px]">Our Mission</strong><br />
                ...
                <br /><br />
                <strong className="text-[20px]">Discover the Perfect Hike</strong><br />
                ...
                <br /><br />
                <strong className="text-[20px]">Personalized Recommendations</strong><br />
                ...
                <br /><br />
                <strong className="text-[20px]">Community and Connection</strong><br />
                ...
                <br /><br />
                <strong className="text-[20px]">Your Adventure Starts Here</strong><br />
                ...
                <br /><br />
                Thank you for choosing HikeHaven as your hiking companion. Let's explore the world, one trail at a time!
            </div>
        </div>
     );
}
